...
class l1a_bad_pixel_removal(object):
    """
    ...
    def dead_pixels(self, image):
        ...
        image[self.specs.BadPixelsBig[0][2]-iy0-1: self.specs.BadPixelsBig[0][3]-iy0-1,
        self.specs.BadPixelsBig[0][0]-ix0-1: self.specs.BadPixelsBig[0][1]-ix0-1] = np.nan
    ...
    def interp_bad_pixels(self, image):
        ...
        for i in range(np.shape(image)[1]):
            ...
            if len(index[0]) > 0:
                ...
                image[index, i] = np.interp(index[0], good_index[0], image[good_index[0], i])
    ...
    def dust_offset_pixels(self, image):
        ...
        p = ([206, 92], [154, 294], [154, 295], [155, 295], [114, 155],
                            [129,199], [133,200], [108,53], [108,51], [76,88], [31,56],
                            [129,199], [133,200], [27, 226], [24, 225], [209,25], [180,51],
                            [44,3], [146,25],[90,170], [85,174], [41,185], [45, 186], [150,174],
                            [129,199], [130,199], [172, 301], [81, 320], [184,417], [113,368],[113,369],
                             [80,363], [80,364], [74,372], [83,364],[105,439], [190,330], [6,420],
                             [180,51],[181,51], [12,434],[178,286], [249,6], [302,66],[35,109],[74,11],
                            [78,11],[35,286],[25,438], [271,336],[11,78],[35,107],[274,178],[269,196],[238,130],
             [219,292],[96,444],[154,436], [194,273],[167,328],[156,80],[61,188],[296,363],[296,452],[155,148],
             [76,113],[91,127],[7,328],[225, 233],[187,493],[187,77], [137,244], [214,101])
